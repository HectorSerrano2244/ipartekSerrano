...
public class AgenteServiceTest {
	...
	public void existe() {
		...
		Agente agente = aService.existe("889", "asa");
		...
		agente = aService.existe("987987", "987987");
	...
	public void obtenerMultas() {
		...
		int idAgente = -1;
		ArrayList<Multa> multas = (ArrayList<Multa>) aService.obtenerMultas(idAgente, estado);
		...
		idAgente = 1;
		multas = (ArrayList<Multa>) aService.obtenerMultas(idAgente, estado);
